(** once opam is installed, run with coretop day1_part2.ml **)
...
let rec partition_3 acc = function
  | [] | [_] | [_;_]  -> List.rev acc
  | x :: y :: z :: tl -> partition_3 ((x + y +z)::acc) (y::z::tl)
...
let () =
  ...
  printf "day1_part2: %d\n" (count_growing 0 (partition_3 [] depths))
